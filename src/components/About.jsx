  ...
  return (
    <>
      <div className={AboutStyle.about}>
        <div className={AboutStyle.aboutBanner}>
          <h1>About</h1>
        </div>
        <div className={AboutStyle.ourStory}>
          <div className={AboutStyle.storyContent}>
            <h1>Our Story</h1>
            <p>
          ...
          <div className={AboutStyle.storyImgContainer}>
            <div className={AboutStyle.storyImg}></div>
          </div>
        </div>
        <div className={AboutStyle.ourMission}>
          <div className={AboutStyle.missionImgContainer}>
            <div className={AboutStyle.missionImg}></div>
          </div>
